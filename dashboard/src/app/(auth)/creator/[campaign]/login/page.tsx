/**
 * /creator/<campaign>/login — campaign-scoped creator sign-in.
...
export default async function CreatorLoginCampaignPage({
  params,
}: {
  ...
  return (
    <>
      <CreatorAuthForm defaultTab="signin" copy={copy} campaign={campaign} />
