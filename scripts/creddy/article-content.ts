...
const APP_STORE_ICON = '<svg aria-hidden="true" viewBox="0 0 24 24"><path d="M8.6 16.8h6.8M9.7 14.7l3.8-6.6c.5-.9 1.9-.1 1.4.8l-3.8 6.6m-2.9-5.1 5.2 9c.5.9-.8 1.7-1.4.8l-5.2-9c-.5-.9.9-1.7 1.4-.8Zm6.5 5.2 2.2 3.8c.5.9-.8 1.7-1.4.8l-2.2-3.8"/></svg>';
