...
function renderBlock(
  ...
  switch (block.type) {
    ...
    case 'visual': {
      ...
      return `<figure class="visual" data-visual-id="${escapeHtml(block.visualId)}"><div class="visual-frame">${media}</div><figcaption>${escapeHtml(block.caption)}</figcaption></figure>`;
    }
