...
function renderBlock(
  ...
  switch (block.type) {
    ...
    case 'visual': {
      ...
      return `<figure class="visual" data-visual-id="${escapeHtml(block.visualId)}"><div class="visual-ornaments" aria-hidden="true"><span class="ornament-dollar">$</span><span class="ornament-points">◎</span><span class="ornament-growth">↗</span><span class="ornament-spark">✦</span></div><div class="visual-frame">${media}</div><figcaption>${escapeHtml(block.caption)}</figcaption></figure>`;
    }
