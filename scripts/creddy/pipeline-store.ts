...
export const CREDDY_DATA_DIRECTORIES = [
  ...
  '04-analysis-queue',
  '04-official-verification/pending',
  '04-official-verification/completed',
  '04-official-verification/history',
  '05-content-opportunities',
  '05-content-opportunities/evergreen',
  '05-editorial-ledger/items',
  '05-editorial-ledger/authorizations',
  '05-editorial-ledger/daily-selections',
  '05-editorial-ledger/urgent-claims',
  '05-editorial-ledger/hourly-runs',
  '06-content-drafts/scripts',
  '06-content-drafts/revisions',
